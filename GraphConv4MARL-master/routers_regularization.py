...
model_r.compile(optimizer=Adam(lr=0.000003), loss='kullback_leibler_divergence')  # KL divergence
...
while(1):
	...
	relation_presentation = model_r.predict(new_states)  # relationship
